...
public class LichSuDatXeAdapter extends RecyclerView.Adapter<LichSuDatXeAdapter.ViewHolder> {

    Context context;
    int layout;
    ArrayList<HoaDon> hoaDonArrayList;

    public LichSuDatXeAdapter(Context context, int layout, ArrayList<HoaDon> hoaDonArrayList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new LichSuDatXeAdapter.ViewHolder(v);
    }
    ...
    private void onClickGoToHoaDonDetail(HoaDon hoadon){
        Intent i = new Intent(context, ChiTietHoaDonDatXeActivity.class);
        Bundle b = new Bundle();
