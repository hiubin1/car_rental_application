...
public class QuanLyHopDongAdapter extends RecyclerView.Adapter<QuanLyHopDongAdapter.ViewHolder>{
    ...
    public QuanLyHopDongAdapter(Context context, int layout, ArrayList<HopDong> hopDongArrayList) {
    ...
    @NonNull
    @Override
    public QuanLyHopDongAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(layout,parent,false);
        return new QuanLyHopDongAdapter.ViewHolder(v);
    }
    ...
    private void onClickGoToHopDongDetail(HopDong hopDong){
        Intent i = new Intent(context, ChiTietHopDongActivity.class);
        Bundle b = new Bundle();
